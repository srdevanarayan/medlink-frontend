...
import styled from 'styled-components';
import {Logo} from "../images/images"
import homebutton from '../../MedLink-Icons/homebutton.png';
...
const Navbar=()=>{
  return (
     <>
      <Nav>
        <NavLink to='/'>
          <img src={Logo} alt='logo' height="50px" width="80px" style={{height:"80%"}} />
        </NavLink>
        <Bars />
        <NavMenu>
        ...
        <NavBtn>
          <NavBtnLink to='/'>
          <img src={homebutton} height="20px" width="20px" alt="" />
          </NavBtnLink>
        </NavBtn>
      </Nav>
    </>
