...
function CreateRequest() {
  ...
  return (
    ...
    <Card className='column-center'  style={{border:"1px solid #10B3A0", borderRadius:"2em",gap:"2em"}}>
    <div><h2 style={textColor}>Create new request</h2></div>
    
    <div className='row-center' style={{height:"39px",gap:"2%"}}>
          <div style={{width:"50%",padding:"10px 0px 0px 0px"}}>
          <label htmlFor="username" style={{color:"#17EFF4", padding:"20px 0px",height:"39px"}}>Disease</label>
          </div>
        <Label
        ...
        <div className='row-center' style={{height:"39px",gap:"2%"}}>
          <div style={{width:"50%",padding:"10px 0px 0px 0px"}}>
          <label htmlFor="username" style={{color:"#17EFF4", padding:"20px 0px",height:"39px"}}>Age</label>
          </div>
        <Label
          placeholderStyle="label"
          type="text"
      ...
      <div className='row-center' style={{height:"39px",gap:"2%"}}>
        ...
        /></div>
          ...
          <div style={{display:"flex",justifyContent:"center"}}>
            <CardButton style={submitButtonStyle} onClick={Login}>SUBMIT</CardButton>
          </div>
    </Card>
